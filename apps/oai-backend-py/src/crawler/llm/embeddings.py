...
class OllamaEmbedder(Embedder):
    ...
    def embed(self, query: str) -> list[float]:
        ...
        return cast(list[float], embedding.embedding)
    ...
    def embed_batch(self, queries: list[str]) -> list[list[float]]:
        ...
        return cast(list[list[float]], embeddings.embeddings)
    ...
    def get_dimension(self) -> int:
        ...
        if self.config.dimension is not None:
            ...
            if self._dimension is None:
                raise RuntimeError("Dimension is None after assignment")
        ...
        if self._dimension is None:
            raise RuntimeError("Dimension is None after calculation")
        return self._dimension
