...
metadata_schema = {
    "type": "object",
    "required": schema1.get("required", [])
    + ["summary_item_1", "summary_item_2", "summary_item_3"],
    "properties": {
...
def create_church_config() -> CrawlerConfig:
    ...
    extractor = MetadataExtractorConfig(
        json_schema=metadata_schema, context="Religious and church documents"
    )
    ...
    converter = PyMuPDF4LLMConfig(
        ...
        image_prompt="Describe this image in detail for a religious document.",
        max_workers=4,
        to_markdown_kwargs={
            "page_chunks": False,
            "embed_images": True,
